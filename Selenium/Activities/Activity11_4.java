...
public class Activity11_4 {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        String newTabText = driver.findElement(By.xpath("//div/div/div/div[@class='content']")).getText();
        ...
        //Get heading on new page
        newTabText = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div")).getText();
        System.out.println("New tab heading is: " + newTabText);
